...
# initialize variables / constant variables / non-default options for string_checker

payment_ans = ('cash', 'credit')

#initialize ticket prices / credit surcharge (5%)
...
while True:
    ...
    #calculation of the credit surcharge, if the user's payment_method is cash, the surcharge will return 0, else the surcharge is calculated
    if pay_method == 'cash':
        surcharge = 0
    else:
